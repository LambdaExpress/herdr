...
/// Clips a placement, optionally refusing to paint below `safe_bottom`.
///
/// SIXEL hosts scroll their surface when an image reaches the last terminal
/// row, so callers pass the last row content may occupy.
